    ...
    <body>
        <header class="with-background">
            ...
            <div class="hero container">
                ...
                <div class="hero-copy">
                    <h1>100% Organic</h1>
                    <p>Guaranteed 100% Organic Products in Organic's</p>
            ...
            <div class="container">
                ...
                <div class="products text-center">
                    @foreach($products as $product)
                      <div class="product">
                          <a href="{{route('shop.show', $product->id)}}"><img src="{{asset('storage/'.$product->img_default)}}" width="300" height="170" alt="product"></a>
